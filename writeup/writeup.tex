...
We show that by using the prefix-sum based algorithm as a subroutine within the
randomized algorithm, one can combine the theoretical guarantees of both
algorithms, achieving span $O(\log n \cdot \log \log n)$ and provably
optimal cache behavior up to low-order terms.
