...
A low-space implmentation of the algorithm leverages its improved
...
of auxilary memory allocated at a given moment in the execution never
...
\footnote{ %% TODO XXX ALEK ALEK ALEK  added an alternate explanation BILL CHECK THIS
