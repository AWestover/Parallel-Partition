...
\title{\Large In-Place Parallel-Partition Algorithms \\using Exclusive-Read-and-Write Memory} 
  %\thanks{Supported by a Hertz Fellowship and a NSF GRFP Fellowship.}}
