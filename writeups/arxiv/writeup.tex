...
\ref{sec:open}. We also provide detailed pseudocode for our algorithms
in Appendix \ref{sec:pseudocode}.
...
An interesting corollary of Theorem \ref{thm:fullPartition} concerns what happens when $b$ is small (e.g., constant) and we choose $\delta$ to optimize span. 
